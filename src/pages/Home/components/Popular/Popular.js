...
import gbyte from "./img/gbyte.svg";
...
const PopularItem = ({ pegged, name, apy, logo, link }) => {
...
export const Popular = () => {
  ...
  return <div className={styles.wrap}>
    <h2 className={styles.title}>{t("home.popular.title", "Most popular interest bearing tokens")}</h2>
